...
namespace ConexionEjemplo
{
    public partial class Form1 : Form
    {
      ...
      ;
        ...
        private void tboxCompanyName_TextChanged(object sender, EventArgs e)
        {

        }

        private void tboxContacName_TextChanged(object sender, EventArgs e)
        {

        }

        private void tboxContactTitle_TextChanged(object sender, EventArgs e)
        {
